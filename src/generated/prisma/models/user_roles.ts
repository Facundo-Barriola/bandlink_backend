...
export type user_rolesWhereInput = {
  ...
  user_role_id?: Prisma.UuidFilter<"user_roles"> | string
  user_id?: Prisma.UuidFilter<"user_roles"> | string
  role?: Prisma.StringNullableFilter<"user_roles"> | string | null
...
export type user_rolesWhereUniqueInput = Prisma.AtLeast<{
  ...
  created_at?: Prisma.DateTimeFilter<"user_roles"> | Date | string
  users?: Prisma.XOR<Prisma.UsersScalarRelationFilter, Prisma.usersWhereInput>
}, "user_role_id" | "user_id_role" | "user_id_role">
...
export type user_rolesScalarWhereWithAggregatesInput = {
  ...
  user_role_id?: Prisma.UuidWithAggregatesFilter<"user_roles"> | string
  user_id?: Prisma.UuidWithAggregatesFilter<"user_roles"> | string
  role?: Prisma.StringNullableWithAggregatesFilter<"user_roles"> | string | null
...
export type user_rolesOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"user_role_id" | "user_id" | "role" | "created_at", ExtArgs["result"]["user_roles"]>
...
export interface user_rolesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many User_roles and only return the `user_role_id`
   * const user_rolesWithUser_role_idOnly = await prisma.user_roles.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more User_roles and only return the `user_role_id`
   * const user_rolesWithUser_role_idOnly = await prisma.user_roles.updateManyAndReturn({
   *   select: { user_role_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface user_rolesFieldRefs {
  readonly user_role_id: Prisma.FieldRef<"user_roles", 'String'>
